...
def render_command(template: str, context: ExecutionContext, handoff_file: str) -> str:
    ...
    values = {
        ...
        "system_prompt": context.agent_instructions or "",
        "system_prompt_file": "",  # written separately if needed
    }
...
class _ShellBackend:
    ...
    executable_name, model_env_var, effort_env_var.
    """
...
class CodexBackend(_ShellBackend):
    ...
    effort_env_var = "ARIADNE_CODEX_REASONING_EFFORT"
...
class ClaudeBackend(_ShellBackend):
    ...
    effort_env_var = "ARIADNE_CLAUDE_EFFORT"
